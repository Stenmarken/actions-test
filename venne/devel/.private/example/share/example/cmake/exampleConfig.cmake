...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /home/stenmarken3/Egna/actions-test/venne/src/example)
  set(example_DEVEL_PREFIX /home/stenmarken3/Egna/actions-test/venne/devel/.private/example)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /home/stenmarken3/Egna/actions-test/venne/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'stenmarken3 <stenmarken3@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stenmarken3/Egna/actions-test/venne/src/example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/stenmarken3/Egna/actions-test/venne/devel/.private/example/lib;/home/stenmarken3/Egna/actions-test/venne/devel/.private/catkin_tools_prebuild/lib;/home/stenmarken3/Egna/actions-test/venne/devel/lib;/home/stenmarken3/Skola/slam/fastslam2/devel/lib;/home/stenmarken3/Skola/slam_workspace/devel/lib;/opt/ros/melodic/lib)
